...
const fr = {
  translation: {
    ...
    projects: {
      ...
      noProjectsDesc: "Aucun projet ne correspond aux critères sélectionnés.",
      showAll: "Voir tous les projets",
      ctaTitle: "Intéressé par mon travail ?",
      ctaSubtitle: "Discutons de votre prochain projet ensemble",
...
const en = {
  translation: {
    ...
    projects: {
      ...
      noProjectsDesc: "No projects match the selected criteria.",
      showAll: "View all projects",
      ctaTitle: "Interested in my work?",
      ctaSubtitle: "Let's discuss your next project together",
