      ...
      <div className="relative max-w-md mx-auto">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 pl-12 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-foreground placeholder-gray-500 dark:placeholder-gray-400"
          />
